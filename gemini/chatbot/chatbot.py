...
with st.form("user_info_form"):
    ...
    # Phone number validation using regular expression
    def is_valid_phone(user_phone):
      pattern = r'^\d{10}$'  # Allow 10 digits without dashes
      return re.match(pattern, user_phone) is not None
...
if submit_info_button:
    if "call" in user_question.lower() and call_request:
        # Acknowledge the request for a call positively and prompt for information
